...
def subtitles():
  ...
  with open(r'L:\SIH\Backend\out\result2.json', 'r') as f:
  ...
  def create_caption(textJSON, framesize,font = r"L:\SIH\Backend\method\Akshar.ttf",color='white', highlight_color='yellow',stroke_color='white',stroke_width=1.5):
  ...
  vid_path = r"L:\SIH\Backend\out\output.mp4"
